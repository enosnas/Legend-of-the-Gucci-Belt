...
public class PlatformSpawnerRight : MonoBehaviour
{
    ...
    private void InitializePlatforms()
    {
        ...
        {
            platform.GetComponent<MovingPlatformRight>().InitializePlatform();
        }
    }
    ...
    private void SendPlatform()
    {
        ...
        platforms[FindPlatform()].GetComponent<MovingPlatformRight>().ActivatePlatform();
    }
